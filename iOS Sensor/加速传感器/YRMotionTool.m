...
static YRMotionTool * _tool;
@implementation YRMotionTool


+ (instancetype)shareTool {
    
    if (!_tool) {
        _tool =  [[YRMotionTool alloc] init];
    }
    return _tool;
}
...
- (void)addAimView:(UIView *)ballView {
    ...
    [self.referenceView addSubview:ballView];
...
-  (UICollisionBehavior *)collision {
    ...
    if (_collision == nil) {
        ...
        [nosePath1 addQuadCurveToPoint:CGPointMake(210, 340) controlPoint:CGPointMake(185, 320)]; // // 给定终点和控制点绘制贝塞尔曲线
